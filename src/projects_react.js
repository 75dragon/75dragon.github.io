function ListWithLinks(props) {
  ...
  return (
    <ul id="dropdownLink" class="dropdown-content">{listItems}</ul>
  );
}
...
ReactDOM.render(
  <ListWithLinks data={ListWithProjectData} />,
    ...
    return (
      <div class="container">
        ...
        <div class="section">
          ...
          Goals!<br/>
          -Allow website users to use the bot. (Model, Tokenizer, and Script already saved in GitHub. Need to find a way to host)<br/>
        </div>
      </div>
    );
  }
